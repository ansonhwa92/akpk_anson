...
namespace FEP.Model
{
    ...
    public enum Modules
    {
        ...
        [Display(Name = "News Article Management")]
        NewsArticleManagement = 10
    }
    ...
    public enum UserAccess
    {
        ...
        //NewsArticle 9501 - 10000
        [Display(Name = "NewsArticle Menu")]
        NewsArticleMenu = 9501,

        [Display(Name = "NewsArticle - Manage")]
        NewsArticleManage = 9502,

        [Display(Name = "NewsArticle - Manage - View")]
        NewsArticleView = 9503,

        [Display(Name = "NewsArticle - Manage - Create")]
        NewsArticleAdd = 9504,

        [Display(Name = "NewsArticle - Manage - Update")]
        NewsArticleEdit = 9505,

        [Display(Name = "NewsArticle - Manage - Delete")]
        NewsArticleDelete = 9506,
